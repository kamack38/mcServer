...
curl "https://dev.bukkit.org/projects/player-heads/files/latest" -L -o plugins/PlayerHeads.jar
...
explorer.exe https://github.com/AuthMe/AuthMeReloaded/releases/latest
explorer.exe https://github.com/NEZNAMY/TAB/releases
explorer.exe https://dev.bukkit.org/projects/bettersleeping-1-13-1-15/files/latest
